...
public class buscadorFolaidas extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(@NonNull MenuItem item) {
        ...
        if (id==R.id.fav){
            Intent intent = new Intent(buscadorFolaidas.this, Favoritas.class);
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_buscador_folaidas);
    ...
    private void cargarFoliadas(){
        api.getAll().enqueue(new Callback<List<Foliada>>() {
            ...
            public void onFailure(Call<List<Foliada>> call, Throwable t) {
                Toast.makeText(buscadorFolaidas.this, "Error cargando foliadas", Toast.LENGTH_SHORT).show();
            }
        });
    }

    private void buscarNombre(String nombre){
        api.buscarFoliadas(nombre).enqueue(new Callback<List<Foliada>>() {
            @Override
            public void onResponse(Call<List<Foliada>> call, Response<List<Foliada>> response) {
                if (response.isSuccessful()&& response.body()!=null){
            ...
            @Override
            public void onFailure(Call<List<Foliada>> call, Throwable t) {
                Toast.makeText(buscadorFolaidas.this, "Error al buscar", Toast.LENGTH_SHORT).show();
            }
        });
    }
}